    ...
    UUPSUpgradeable
{
    ...
    function computeTimeFactor(
        ...
        int256 betaWad = marginCalculatorParameters.betaWad;

        require(betaWad != 0, "B0");

        int256 tMaxWad = marginCalculatorParameters.tMaxWad;
    ...
    function computeApyBound(
        ...
        int256 beta4Wad = marginCalculatorParameters.betaWad << 2;
        int256 alpha4Wad = marginCalculatorParameters.alphaWad << 2;
        ...
        apyBoundVars.zetaWad = (
            marginCalculatorParameters.sigmaSquaredWad.mul(
        ...
        apyBoundVars.lambdaDenWad = marginCalculatorParameters
            .sigmaSquaredWad
