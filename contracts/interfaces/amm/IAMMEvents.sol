...
interface IAMMEvents {
    ...
    /// @param amount The amount of liquidity minted to the position range
        /// @param amount0 How much token0 (fixed 1% tokens) was required for the minted liquidity
    /// @param amount1 How much token1 (variable tokens) was required for the minted liquidity
    event Mint(
        address sender,
