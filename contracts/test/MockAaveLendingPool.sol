...
contract MockAaveLendingPool is IAaveV2LendingPool {
    ...
    mapping(address => uint256) internal reserveNormalizedIncome;
     ...
     function getReserveNormalizedIncome(address _underlyingAsset) external override view returns (uint256) {
         return reserveNormalizedIncome[_underlyingAsset];
     }

     function setReserveNormalizedIncome(address _underlyingAsset, uint256 _reserveNormalizedIncome) external {
