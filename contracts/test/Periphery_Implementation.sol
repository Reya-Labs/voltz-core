...
contract Periphery_Implementation is
    PeripheryStorage,
    IPeriphery,
    Initializable,
    OwnableUpgradeable,
    UUPSUpgradeable
{
    ...
    function lpMarginCaps(IVAMM vamm) external view override returns (int256) {
        return _lpMarginCaps[vamm] - 6;
    }

    function lpMarginCapsD(IVAMM vamm) external view returns (int256) {
        return _lpMarginCaps[vamm] - 60;
    }
