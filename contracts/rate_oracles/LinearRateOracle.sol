...
abstract contract LinearRateOracle is BaseRateOracle {
    ...
    /// @dev We execute linear interpolation: the slope (slopeFromBeforeOrAtToAtOrAfter) is given by apyFromBeforeOrAtToAtOrAfter / timeInOneYear.
    /// @dev To get the interpolated rate, resolve slopeFromBeforeOrAtToQueryTime = slopeFromBeforeOrAtToAtOrAfter
    /// @dev Resulting in rateValue = beforeOrAtRateValue + timeDeltaBeforeOrAtToQueriedTimeWad * slopeFromBeforeOrAtToAtOrAfter
