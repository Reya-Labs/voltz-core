...
contract MarginEngineHelpers {
    ...
    function checkPositionMarginAboveRequirement(
        ...
        require(
            updatedMarginWouldBe > positionMarginRequirement,
            "Cannot have less margin than the minimum requirement"
        );
    }
    ...
    function checkTraderMarginCanBeUpdated(
        ...
        if (Time.blockTimestampScaled() >= amm.termEndTimestamp()) {
            require(
                isTraderSettled,
                "Trader's margin cannot be updated unless the trader is settled"
            );
    ...
    function checkTraderMarginAboveRequirement(
        ...
        require(
            updatedMarginWouldBe > traderMarginRequirement,
            "Cannot have less margin than the minimum requirement"
        );
    }
}
