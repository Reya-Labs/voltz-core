...
library FixedAndVariableMath {
    ...
    {
        timeInYears = PRBMathUD60x18.div(
            timeInSecondsAsWad,
    ...
    function fixedFactor(
        ...
        fixedFactorValue = PRBMathUD60x18.div(timeInYears, ONE_HUNDRED_IN_WAD);
    }
    ...
    function calculateFixedTokenBalance(
        ...
        fixedTokenBalance = PRBMathSD59x18.div(
            numerator,
            int256(fixedFactor(true, termStartTimestamp, termEndTimestamp))
        );
    }
    ...
    function getExcessBalance(
        ...
        accruedValues.excessFixedAccruedBalance = PRBMathSD59x18.mul(
            amount0,
            int256(fixedFactor(false, termStartTimestamp, termEndTimestamp))
        );

        accruedValues.excessVariableAccruedBalance = PRBMathSD59x18.mul(
            amount1,
        ...
        accruedValues.excessBalance =
            ...
            accruedValues.excessVariableAccruedBalance;
