...
describe('Tick', () => {
    ...
    describe('#getVariableTokenGrowthInside', () => {
        it('test for variable token growth', async () => {
            ...
            const variableTokenGrowthInside = await tickTest.getVariableTokenGrowthInside(0, 0, 0, 0)
    ...
    describe('#getFixedTokenGrowthInside', () => {
        it('test for fixed token growth', async () => {
            ...
            const fixedTokenGrowthInside = await tickTest.getFixedTokenGrowthInside(0, 0, 0, 0)
