...
//   const exp1: BigNumber = mul(
//     fixedTokenBalance,
//     fixedFactor(true, termStartTimestamp, termEndTimestamp)
//   );

//   const exp2: BigNumber = mul(
//     variableTokenBalance,
//     worstCaseVariableFactorAtMaturity(timeInSeconds, isFT, isLM)
//   );

//   let margin: BigNumber = add(exp1, exp2);

//   const minimumMargin: BigNumber = getMinimumMarginRequirement(
//     fixedTokenBalance,
//     variableTokenBalance,
//     termStartTimestamp,
//     termEndTimestamp,
...
//       const expected = getMinimumMarginRequirement(
//         fixedTokenBalance,
//         variableTokenBalance,
//         termStartTimestamp,
//         termEndTimestamp,
