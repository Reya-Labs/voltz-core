...
// import { IAaveLendingPool } from "../typechain/IAaveLendingPool";
...
//       const rateTermStart = await rateOracleTest.rates(
//         daiAddress,
//         toBn(termStartTimestamp.toString())
//       );
//       const rateTermEnd = await rateOracleTest.rates(
//         daiAddress,
...
//       let expectedVariableFactor: BigNumber = div(
//         rateTermEnd[2],
//         rateTermStart[2]
//       );
//       expectedVariableFactor = sub(expectedVariableFactor, toBn("1"));
