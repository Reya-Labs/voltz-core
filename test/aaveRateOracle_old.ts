...
// async function variableFactorAtMaturity(
//   underlyingToken: string,
//   termStartTimestamp: BigNumber,
//   termEndTimestamp: BigNumber,
//   rateOracle: AaveRateOracle
// ): Promise<BigNumber> {
//   await network.provider.send("evm_setNextBlockTimestamp", [
//     termStartTimestamp.toNumber(),
//   ]);
//   await rateOracle.updateRate(underlyingToken);
//   await network.provider.send("evm_setNextBlockTimestamp", [
//     termEndTimestamp.toNumber(),
//   ]);
//   await rateOracle.updateRate(underlyingToken);

//   const rateTermStartTimestamp = await rateOracle.rates(
//     underlyingToken,
//     termStartTimestamp
//   );
//   const rateTermEndTimestamp = await rateOracle.rates(
//     underlyingToken,
//     termEndTimestamp
//   );

//   let currentRateRay: BigNumberJs = new BigNumberJs(
//     rateTermEndTimestamp[2].toString()
//   );
//   let previousRateRay: BigNumberJs = new BigNumberJs(
//     rateTermStartTimestamp[2].toString()
//   );

//   let aaveIndex = currentRateRay.rayDiv(previousRateRay); // in rays

//   let rateFromPoolStartToMaturity: BigNumber = sub(
//     toBn(aaveIndex.toString()),
//     toBn("1000000000000000000000000000")
//   );
//   rateFromPoolStartToMaturity = div(
//     rateFromPoolStartToMaturity,
...
//       const reserveNormalisedIncome: BigNumber =
//         await rateOracle.getReserveNormalizedIncome(daiAddress);

//       const updatedRate = await rateOracle.rates(
//         daiAddress,
//         currentBlockTimestamp
//       );
...
//       const previousRate = await rateOracle.rates(
//         daiAddress,
//         previousBlockTimestamp
//       ); // from

//       const currentRate = await rateOracle.rates(
//         daiAddress,
//         currentBlockTimestamp
//       ); // to

//       let currentRateRay: BigNumberJs = new BigNumberJs(
//         currentRate[2].toString()
//       );
//       let previousRateRay: BigNumberJs = new BigNumberJs(
//         previousRate[2].toString()
//       );
//       // todo: bring ray one
...
//       const result = await rateOracle.getRateFromTo(
//         daiAddress,
//         previousBlockTimestamp,
//         currentBlockTimestamp
//       );
...
//       const expectedVariableFactor: BigNumber = await variableFactorAtMaturity(
//         daiAddress,
//         termStartTimestamp,
//         termEndTimestamp,
//         rateOracle
//       );
//       await rateOracleTest.variableFactorTest(
//         true,
//         daiAddress,
//         termStartTimestamp,
//         termEndTimestamp
//       );
//       const realisedVariableFactor: BigNumber =
//         await rateOracleTest.mostRecentVariableFactor();
