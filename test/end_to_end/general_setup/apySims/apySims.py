...
plt.xlabel("day")
plt.ylabel("margin")
plt.legend(['margin requirement', 'liquidation threshold', 'current margin', 'deposited margin'])
plt.title("Margin analysis")
plt.savefig("test/end_to_end/general_setup/apySims/margin_analysis.png")
plt.clf()
...
plt.savefig("test/end_to_end/general_setup/apySims/fees.png")
plt.clf()
