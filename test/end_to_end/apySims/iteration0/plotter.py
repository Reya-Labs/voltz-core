...
apyDataFrame = pd.read_csv("test/end_to_end/general_setup/apySims/iteration0/apys.csv")
marginDataFrame = pd.read_csv("test/end_to_end/general_setup/apySims/iteration0/margins.csv")
...
plt.plot(apyDataFrame["dates"], [0.27] * len(apyDataFrame["dates"]), linestyle="dashed")
plt.plot(apyDataFrame["dates"], [0.43] * len(apyDataFrame["dates"]), linestyle="dashed")
...
plt.savefig("test/end_to_end/general_setup/apySims/iteration0/apy_bounds.png")
plt.clf()
...
plt.savefig("test/end_to_end/general_setup/apySims/iteration0/rni.png")
plt.clf()
...
plt.savefig("test/end_to_end/general_setup/apySims/iteration0/variable_factor.png")
plt.clf()
...
plt.savefig("test/end_to_end/general_setup/apySims/iteration0/margin_analysis.png")
plt.clf()
