...
apyDataFrame = pd.read_csv("test/end_to_end/general_setup/apySims/iteration1/apys.csv")
marginDataFrame = pd.read_csv("test/end_to_end/general_setup/apySims/iteration1/margins.csv")
...
plt.plot(apyDataFrame["dates"], apyDataFrame["lower fixed rate"], linestyle="dashed")
plt.plot(apyDataFrame["dates"], apyDataFrame["upper fixed rate"], linestyle="dashed")
...
plt.savefig("test/end_to_end/general_setup/apySims/iteration1/apy_bounds.png")
plt.clf()
...
plt.savefig("test/end_to_end/general_setup/apySims/iteration1/rni.png")
plt.clf()
...
plt.savefig("test/end_to_end/general_setup/apySims/iteration1/variable_factor.png")
plt.clf()
...
plt.savefig("test/end_to_end/general_setup/apySims/iteration1/margin_analysis.png")
plt.clf()