...
/*
Below are some of the old tests, since then the architecture changed quite a bit and now AaveRateOracle inherits from a BaseRateOracle which has a
set of virtual functions that all rate oracles need to adhere to.  
*/
